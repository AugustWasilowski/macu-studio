...
export const LOCALES: LocaleMeta[] = [
  ...
  { code: "it", nativeName: "Italiano", englishName: "Italian", dir: "ltr", completeness: 1 },
  { code: "pt-BR", nativeName: "Português (Brasil)", englishName: "Portuguese (Brazil)", dir: "ltr", completeness: 1 },
  { code: "ro", nativeName: "Română", englishName: "Romanian", dir: "ltr", completeness: 1 },
  { code: "ca", nativeName: "Català", englishName: "Catalan", dir: "ltr", completeness: 1 },
  // European
  ...
  { code: "el", nativeName: "Ελληνικά", englishName: "Greek", dir: "ltr", completeness: 1 },
  ...
  { code: "fi", nativeName: "Suomi", englishName: "Finnish", dir: "ltr", completeness: 1 },
  { code: "hu", nativeName: "Magyar", englishName: "Hungarian", dir: "ltr", completeness: 1 },
  ...
  { code: "ja", nativeName: "日本語", englishName: "Japanese", dir: "ltr", completeness: 1 },
  { code: "ko", nativeName: "한국어", englishName: "Korean", dir: "ltr", completeness: 1 },
  // South-East Asian
  { code: "vi", nativeName: "Tiếng Việt", englishName: "Vietnamese", dir: "ltr", completeness: 1 },
  ...
  { code: "ta", nativeName: "தமிழ்", englishName: "Tamil", dir: "ltr", completeness: 1 },
  ...
  { code: "ml", nativeName: "മലയാളം", englishName: "Malayalam", dir: "ltr", completeness: 1 },
  { code: "kn", nativeName: "ಕನ್ನಡ", englishName: "Kannada", dir: "ltr", completeness: 1 },
  // Middle East (RTL)
  { code: "ar", nativeName: "العربية", englishName: "Arabic", dir: "rtl", completeness: 1 },
  { code: "he", nativeName: "עברית", englishName: "Hebrew", dir: "rtl", completeness: 1 },
  { code: "fa", nativeName: "فارسی", englishName: "Persian", dir: "rtl", completeness: 1 },
  // African
  ...
  { code: "yo", nativeName: "Yorùbá", englishName: "Yoruba", dir: "ltr", completeness: 1 },
  ...
  { code: "ig", nativeName: "Igbo", englishName: "Igbo", dir: "ltr", completeness: 1 },
  { code: "af", nativeName: "Afrikaans", englishName: "Afrikaans", dir: "ltr", completeness: 1 },
